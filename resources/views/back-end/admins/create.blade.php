                                    ...
                                    action="{{ route($routeName.'.store') }}"  enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            <div class="col">
                                                ...
                                                <div class="form-group"><label ><strong>{{$inputName}}</strong></label><input class="form-control" type="text"
                                                         name="{{$inputName}}" value="{{old($inputName) }}"></div>
                                            </div>
                                            <div class="col">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="form-group"><label ><strong>{{$inputName}}</strong></label>
                                                    <input class="form-control" type="email" name="{{$inputName}}" 
                                                    value="{{old($inputName) }}"
                                                    ></div>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="form-group"><label ><strong>{{$inputName}}</strong></label>
                                                    <input class="form-control" type="password" name="{{$inputName}}" value="{{old($inputName) }}" ></div>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="col" style="width: 50%">
                                                @php $inputName = 'role' ; @endphp
                                                <div class="form-group"><label ><strong>role</strong></label>
                                                   <select class="form-control" name="{{$inputName}}">
                                                       <option value="10">master admin</option>
